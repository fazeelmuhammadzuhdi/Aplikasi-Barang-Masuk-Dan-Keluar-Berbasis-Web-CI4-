...
<head>
    ...
    <title>Laporan Detail Barang Keluar</title>
</head>
            ...
            <td>
                <table style="width: 100%; text-align: center;" border="0">
                    <tr style="text-align: center;">
                        <td>
                            <h3><u> Laporan Detail Barang Keluar</u></h3><br>
                                ...
                                <table border="1" celpadding="5"
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($datalaporan->getResultArray() as $row) :
                                            $totalSeluruh += $row['totalharga1910021'];
                                        ?>
                                        <tr>
                                            <td><?= $nomor++; ?></td>
                                            ...
                                            <td><?= $row['dethargajual1910021'] ?></td>
                                            <td><?= $row['detjml1910021'] ?></td>
