                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <?= number_format($row['dethargamasuk1910021'], 0, ",", ".") ?></td>
                            <td style="text-align: right;">
                                <?= number_format($row['dethargajual1910021'], 0, ",", ".") ?></td>
                            <td style="text-align: center;">
                                <?= number_format($row['detjml1910021'], 0, ",", ".") ?></td>
                            <td style="text-align: right;">
                                <?= number_format($row['detsubtotal1910021'], 0, ",", ".") ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
