...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-outline-secondary" type="button" id="tombolCariBarang">
            ...
            <div class="form-group col-md-1">
                ...
                <div class="input-group">
                    ...
                    <button type="button" class="btn btn-sm btn-secondary" title="Reload Data" id="tombolReload">
        ...
        <div class="row justify-content-end">
            <button type="button" class="btn btn-sm btn-danger" id="tombolSelesaiTransaksi">
                <i class="fa fa-save"> Selesai Transaksi</i>
            </button>
        </div>
    </div>
</div>
    ...
    $('#tombolSelesaiTransaksi').click(function(e) {
        ...
        if (faktur.length == 0) {
            ...
            Swal.fire({
                ...
                text: "Yakin Transaksi DiSimpan ?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#04CFFA',
                cancelButtonColor: '#FA6804 ',
