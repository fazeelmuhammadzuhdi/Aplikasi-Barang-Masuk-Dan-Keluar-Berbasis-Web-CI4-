        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    ?>
                    <input type="text" name="iduser" class="form-control <?= $isInvalidUser ?>"
                        placeholder="Inputkan Id User" autofocus>
                ...
                <div class="input-group mb-3">
                    ...
                    if (session()->getFlashdata('errPassword')) {
                        $iserrPassword = 'is-invalid';
                    } else {
                        $iserrPassword = '';
                    }
                    ?>
                    <input type="password" name="pass" class="form-control <?= $iserrPassword ?>"
