...
<head>
    ...
    <title>Aplikasi Gudang Barang Masuk Dan Keluar</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?= base_url() ?>/dist/img/images.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('kategori/index'); ?>" class="nav-link">
                                <i class="nav-icon fa fa-angry text-danger"></i>
                                <p class="text">Kategori</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= site_url('satuan/index'); ?>" class="nav-link">
                                <i class="nav-icon fa fa-smile text-warning"></i>
                                <p class="text">Satuan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= site_url('barang/index'); ?>" class="nav-link">
                                <i class="nav-icon fa fa-frown-open text-secondary"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('barangmasuk/data'); ?>" class="nav-link">
                                <i class="nav-icon fa fa-hand-point-down text-primary"></i>
                                <p class="text">Barang Masuk</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= site_url('barangkeluar/data'); ?>" class="nav-link">
                                <i class="nav-icon fa fa-hand-point-up text-purple"></i>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; Fazeel Muhammad
        </footer>
